...
function Options.Register()
  ...
  if CreateSettingsButtonInitializer and SettingsPanel and SettingsPanel.GetLayout then
    ...
    if layout and layout.AddInitializer then
      ...
      command("chat demo", "chat demo", nil, "Run", "A pretend party of three and pretend drops, so every Tell party and Ask button can be seen without a group. Every click is a dry run. In chat, /sift chat demo off ends it.", { dev = true })
